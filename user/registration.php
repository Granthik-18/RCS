				...
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<div class="form-group mb-3">
							...
							<input type="text" pattern="[A-Za-z]+" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus >
						</div>
		             ...
		             <span id="user-availability-status1" style="font-size:12px;"></span>
						...
						<div class="form-group mb-3">
							...
							<input type="tel" class="form-control" pattern="[1-9]{1}[0-9]{9}" maxlength="10" name="contactno" placeholder="Contact no" required="required" autofocus>
						</div>
						<div class="form-group mb-3">
