...
<body>
      ...
      <div class="container-fluid ">
         <div class="row">
            <div class="col-sm-2 col-6">
               <a class="logo" href="index.php"><h1 style="font-size: 50px;color: white; margin-top: -25px; ">RCS</h1></a>
            </div>
   ...
   <div class="copyright_section">
      <div class="container">
         <p class="copyright_text">&copy Complaint Management System.</p>
      </div>
   </div>
